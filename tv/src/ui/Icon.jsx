/** Feather-style line icons, inline so the TV needs no icon font. */
const PATHS = {
...
export default function Icon({ name, size = '1em', color = 'currentColor', strokeWidth = 1.8, style }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, ...style }} aria-hidden="true">
      {PATHS[name] ?? null}
    </svg>
  );
}
